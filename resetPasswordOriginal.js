...
const bcrypt = require('bcrypt'); // Usar bcrypt original
...
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/pirata_tech')
  .then(async () => {
    ...
    // Establecer nueva contraseña usando bcrypt original
    ...
    console.log('Contraseña actualizada correctamente con bcrypt original');
